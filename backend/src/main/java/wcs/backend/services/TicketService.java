...
public class TicketService {
    ...
    public Ticket createTicket(Ticket ticket, User creator) {
      ...
      // Si la catégorie spécifiée dans le ticket est nulle, utilisez "non renseigné" (ou une autre valeur par défaut)
      if (ticket.getCategory() == null) {
          ticket.setCategory(defaultCategory);
      }
      
      // Si la priorité spécifiée dans le ticket est nulle, utilisez "non renseigné" (ou une autre valeur par défaut)
